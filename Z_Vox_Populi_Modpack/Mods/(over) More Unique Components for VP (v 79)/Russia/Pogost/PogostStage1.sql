...
INSERT INTO Buildings 	
			(Type,						BuildingClass,						CityConnectionGoldModifier, GoldMaintenance, Cost,	FaithCost,	EnhancedYieldTech, TechEnhancedTourism, AllowsRangeStrike, Defense,	ExtraCityHitPoints, TrainedFreePromotion, CitySupplyFlat, DefenseHappinessChange, GreatPeopleRateModifier, GreatWorkSlotType, GreatWorkCount, FreshWater, FreeStartEra, Happiness, NeverCapture, 	ArtDefineTag, MinAreaSize, ConquestProb, 	HurryCostModifier,	Help,										Description,						IconAtlas,					PortraitIndex)
...
INSERT INTO Buildings 	
			(Type,						BuildingClass,						CityConnectionGoldModifier,	GoldMaintenance, 	Cost,	FaithCost,	EnhancedYieldTech, NoUnhappfromXSpecialists, TechEnhancedTourism, AllowsRangeStrike, Defense,	ExtraCityHitPoints, TrainedFreePromotion,	CitySupplyFlat,	DefenseHappinessChange, GreatPeopleRateModifier, GreatWorkSlotType, GreatWorkCount, FreshWater, FreeStartEra, Happiness, NeverCapture, 	ArtDefineTag, MinAreaSize, ConquestProb, 	HurryCostModifier,	Help,										Description,						IconAtlas,					PortraitIndex)
