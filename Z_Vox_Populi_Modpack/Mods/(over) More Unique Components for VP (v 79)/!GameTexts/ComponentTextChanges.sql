...
-- Hakkapeliitta
UPDATE Language_en_US 
SET Text = 'Mid-game cavalry, faster and more effective against Wounded Units. Only Sweden may build it. Does not cost [ICON_ARROW_RIGHT] Movement to Pillage, and heals 50 HP when killing an enemy Unit.'
