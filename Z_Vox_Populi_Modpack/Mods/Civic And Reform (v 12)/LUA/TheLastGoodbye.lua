...
function ISawTheLightFadeFromTheSky(iPlayer)
	...
	if (math.fmod(Game.GetElapsedGameTurns(), iDivide) == 0) then
...
function OnTheWindIHeardASigh(iPlayer, iChoice)
	...
	elseif iChoice == iHereditaryRuleChoice then
		...
		if pPlayer:HasPolicy(iHereditaryRule) then
			...
			for pCity in pPlayer:Cities() do
				if BySilverStreamsThatRunDownToTheSea(1, 100) >= 75 and pCity:GetResistanceTurns() < 2 then
	...
	elseif iChoice == iPatronageChoice then
		...
		if pPlayer:HasPolicy(iPatronage) then
			...
			for pCity in pPlayer:Cities() do
				if BySilverStreamsThatRunDownToTheSea(1, 100) >= 85 and pCity:GetResistanceTurns() < 2 then
					pCity:ChangeResistanceTurns(iTurn)
				end
			end
		end
		...
		pPlayer:RevokePolicy(iPoliceState)
		pPlayer:RevokePolicy(iUniversalSuffrage)
		pPlayer:SetEventChoiceCooldown(iPatronageChoice, iDivide)
		pPlayer:SetEventChoiceCooldown(iHereditaryRuleChoice, 0)		
		pPlayer:DoCancelEventChoice(iHereditaryRuleChoice)
		pPlayer:GrantPolicy(iPatronage, true)
		if pPlayer:IsHuman() then
			pPlayer:SetEventChoiceCooldown(iPatronageChoice, -1)
		end
	...
	elseif iChoice == iPoliceStateChoice then
		...
		if pPlayer:HasPolicy(iPoliceState) then
			...
			for pCity in pPlayer:Cities() do
				if BySilverStreamsThatRunDownToTheSea(1, 100) >= 95 and pCity:GetResistanceTurns() < 2 then
					pCity:ChangeResistanceTurns(iTurn)
				end
			end
		end
...
function AsTheSnowflakesCover(iPlayer, iChoice)
	...
	if iChoice == iBarbarismChoice then
		...
		pPlayer:SetEventChoiceCooldown(iConstutionalismChoice, 0)
		pPlayer:DoCancelEventChoice(iConstutionalismChoice)
	...
	elseif iChoice == iConstutionalismChoice then
		...
		pPlayer:SetEventChoiceCooldown(iNationhoodChoice, 0)
		pPlayer:DoCancelEventChoice(iNationhoodChoice)
		pPlayer:SetEventChoiceCooldown(iConstutionalismChoice, iDivide)
		pPlayer:GrantPolicy(iConstutionalism, true)
		if pPlayer:IsHuman() then pPlayer:SetEventChoiceCooldown(iConstutionalismChoice, -1) end
	end
end
...
function NightIsNowFalling(iPlayer, iChoice)
	...
	elseif iChoice == iPacifismChoice then
		...
		if pPlayer:HasPolicy(iPacifism) then
			...
			for pCity in pPlayer:Cities() do
				if BySilverStreamsThatRunDownToTheSea(1, 100) >= 65 and pCity:GetResistanceTurns() < 2 then
					pCity:ChangeResistanceTurns(iTurn)
				end
			end
		end
...
function ThroughLandsWhereNeverLightHasShone(playerID, _, info, tChoiceOverrideStrings)
	...
	elseif info.Type == "PLAYER_EVENT_GOVERNMENTCIVIC_CHOICE_5" then
		table.insert(tChoiceOverrideStrings, {Description = nil, Help = Locale.ConvertTextKey("TXT_KEY_EVENT_GOVERNMENTCIVIC_CHOICE_5_HELP", Players[playerID]:GetBaseBuildingMaintenance()*0.25)})
	elseif info.Type == "PLAYER_EVENT_GOVERNMENTCIVIC_CHOICE_6" then
		table.insert(tChoiceOverrideStrings, {Description = nil, Help = Locale.ConvertTextKey("TXT_KEY_EVENT_GOVERNMENTCIVIC_CHOICE_6_HELP", Players[playerID]:GetBaseBuildingMaintenance()*0.25)})
	...
	elseif info.Type == "PLAYER_EVENT_LEGALCIVIC_CHOICE_3" then
		table.insert(tChoiceOverrideStrings, {Description = nil, Help = Locale.ConvertTextKey("TXT_KEY_EVENT_LEGALCIVIC_CHOICE_3_HELP", Players[playerID]:GetBaseBuildingMaintenance()*0.24, Players[playerID]:GetBaseUnitMaintenance()*0.30)})
	elseif info.Type == "PLAYER_EVENT_LEGALCIVIC_CHOICE_4" then
		table.insert(tChoiceOverrideStrings, {Description = nil, Help = Locale.ConvertTextKey("TXT_KEY_EVENT_LEGALCIVIC_CHOICE_4_HELP", Players[playerID]:GetBaseBuildingMaintenance()*0.24)})
	...
	elseif info.Type == "PLAYER_EVENT_LEGALCIVIC_CHOICE_7" then
		table.insert(tChoiceOverrideStrings, {Description = nil, Help = Locale.ConvertTextKey("TXT_KEY_EVENT_LEGALCIVIC_CHOICE_7_HELP", Players[playerID]:GetBaseBuildingMaintenance()*0.24)})
	...
	elseif info.Type == "PLAYER_EVENT_LABORCIVIC_CHOICE_5" then
		table.insert(tChoiceOverrideStrings, {Description = nil, Help = Locale.ConvertTextKey("TXT_KEY_EVENT_LABORCIVIC_CHOICE_5_HELP", Players[playerID]:GetBaseBuildingMaintenance()*0.23)})
	...
	elseif info.Type == "PLAYER_EVENT_LABORCIVIC_CHOICE_7" then
		table.insert(tChoiceOverrideStrings, {Description = nil, Help = Locale.ConvertTextKey("TXT_KEY_EVENT_LABORCIVIC_CHOICE_7_HELP", Players[playerID]:GetBaseBuildingMaintenance()*0.23)})
	...
	elseif info.Type == "PLAYER_EVENT_ECONOMYCIVIC_CHOICE_5" then
		table.insert(tChoiceOverrideStrings, {Description = nil, Help = Locale.ConvertTextKey("TXT_KEY_EVENT_ECONOMYCIVIC_CHOICE_5_HELP", Players[playerID]:GetBaseBuildingMaintenance()*0.22)})
	elseif info.Type == "PLAYER_EVENT_ECONOMYCIVIC_CHOICE_6" then
		table.insert(tChoiceOverrideStrings, {Description = nil, Help = Locale.ConvertTextKey("TXT_KEY_EVENT_ECONOMYCIVIC_CHOICE_6_HELP", Players[playerID]:GetBaseBuildingMaintenance()*0.22)})
	...
	elseif info.Type == "PLAYER_EVENT_RELIGIONCIVIC_CHOICE_2" then
		table.insert(tChoiceOverrideStrings, {Description = nil, Help = Locale.ConvertTextKey("TXT_KEY_EVENT_RELIGIONCIVIC_CHOICE_2_HELP", Players[playerID]:GetBaseBuildingMaintenance()*0.21)})
		...
		if (pPlayer ~= nil and not pPlayer:IsMinorCiv() and not pPlayer:IsBarbarian()) then
			if (pPlayer:GetTeam() == iTeam) then
				...
				elseif (iTech == GameInfoTypes.TECH_CIVIL_SERVICE) then
					if pPlayer:IsHuman() then
						pPlayer:AddNotification(NotificationTypes.NOTIFICATION_GENERIC, "You have unlocked a new legal civic!", "Manorialism Unlocked!", pPlayer:GetCapitalCity():GetX(), pPlayer:GetCapitalCity():GetY())
					end
				...
				elseif (iTech == GameInfoTypes.TECH_FLIGHT) then
					if pPlayer:IsHuman() then
						pPlayer:AddNotification(NotificationTypes.NOTIFICATION_GENERIC, "You have unlocked a new religion civic!", "Cult of Personality Unlocked!", pPlayer:GetCapitalCity():GetX(), pPlayer:GetCapitalCity():GetY())
					end
