...
SELECT  'PLAYER_EVENT_HEREDITARY_RULE', 'TXT_KEY_PLAYER_EVENT_GOVERNMENTCIVIC_CHOICE_2', 'TXT_KEY_PLAYER_EVENT_GOVERNMENTCIVIC_CHOICE_2_HELP', 'GovernmentCivics.dds', -1, 1, 1, 1 UNION ALL
SELECT  'PLAYER_EVENT_PATRONAGE', 'TXT_KEY_PLAYER_EVENT_GOVERNMENTCIVIC_CHOICE_3', 'TXT_KEY_PLAYER_EVENT_GOVERNMENTCIVIC_CHOICE_3_HELP', 'GovernmentCivics.dds', -1, 1, 1, 1 UNION ALL
SELECT  'PLAYER_EVENT_REPRESENTATION', 'TXT_KEY_PLAYER_EVENT_GOVERNMENTCIVIC_CHOICE_4', 'TXT_KEY_PLAYER_EVENT_GOVERNMENTCIVIC_CHOICE_4_HELP', 'GovernmentCivics.dds', -1, 1, 1, 1 UNION ALL
SELECT  'PLAYER_EVENT_POLICE_STATE', 'TXT_KEY_PLAYER_EVENT_GOVERNMENTCIVIC_CHOICE_5', 'TXT_KEY_PLAYER_EVENT_GOVERNMENTCIVIC_CHOICE_5_HELP', 'GovernmentCivics.dds', -1, 1, 1, 1 UNION ALL
SELECT  'PLAYER_EVENT_UNIVERSAL_SUFFRAGE', 'TXT_KEY_PLAYER_EVENT_GOVERNMENTCIVIC_CHOICE_6', 'TXT_KEY_PLAYER_EVENT_GOVERNMENTCIVIC_CHOICE_6_HELP', 'GovernmentCivics.dds', -1, 1, 1, 1 UNION ALL
SELECT  'PLAYER_EVENT_CONFEDERATION', 'TXT_KEY_PLAYER_EVENT_GOVERNMENTCIVIC_CHOICE_7', 'TXT_KEY_PLAYER_EVENT_GOVERNMENTCIVIC_CHOICE_7_HELP', 'GovernmentCivics.dds', -1, 1, 1, 1 UNION ALL
SELECT  'PLAYER_EVENT_CIVIL_LAW', 'TXT_KEY_PLAYER_EVENT_LEGALCIVIC_CHOICE_2', 'TXT_KEY_PLAYER_EVENT_LEGALCIVIC_CHOICE_2_HELP', 'LegalCivics.dds', -1, 1, 1, 1 UNION ALL
SELECT  'PLAYER_EVENT_VASSALAGE', 'TXT_KEY_PLAYER_EVENT_LEGALCIVIC_CHOICE_3', 'TXT_KEY_PLAYER_EVENT_LEGALCIVIC_CHOICE_3_HELP', 'LegalCivics.dds', -1, 1, 1, 1 UNION ALL
SELECT  'PLAYER_EVENT_BUREAUCRACY', 'TXT_KEY_PLAYER_EVENT_LEGALCIVIC_CHOICE_4', 'TXT_KEY_PLAYER_EVENT_LEGALCIVIC_CHOICE_4_HELP', 'LegalCivics.dds', -1, 1, 1, 1 UNION ALL
SELECT  'PLAYER_EVENT_NATIONHOOD', 'TXT_KEY_PLAYER_EVENT_LEGALCIVIC_CHOICE_5', 'TXT_KEY_PLAYER_EVENT_LEGALCIVIC_CHOICE_5_HELP', 'LegalCivics.dds', -1, 1, 1, 1 UNION ALL
SELECT  'PLAYER_EVENT_FREE_SPEECH', 'TXT_KEY_PLAYER_EVENT_LEGALCIVIC_CHOICE_6', 'TXT_KEY_PLAYER_EVENT_LEGALCIVIC_CHOICE_6_HELP', 'LegalCivics.dds', -1, 1, 1, 1 UNION ALL
SELECT  'PLAYER_EVENT_CONSTITUIONALISM', 'TXT_KEY_PLAYER_EVENT_LEGALCIVIC_CHOICE_7', 'TXT_KEY_PLAYER_EVENT_LEGALCIVIC_CHOICE_7_HELP', 'LegalCivics.dds', -1, 1, 1, 1 UNION ALL
SELECT  'PLAYER_EVENT_SLAVERY', 'TXT_KEY_PLAYER_EVENT_LABORCIVIC_CHOICE_2', 'TXT_KEY_PLAYER_EVENT_LABORCIVIC_CHOICE_2_HELP', 'LaborCivics.dds', -1, 1, 1, 1 UNION ALL
SELECT  'PLAYER_EVENT_SERFDOM', 'TXT_KEY_PLAYER_EVENT_LABORCIVIC_CHOICE_3', 'TXT_KEY_PLAYER_EVENT_LABORCIVIC_CHOICE_3_HELP', 'LaborCivics.dds', -1, 1, 1, 1 UNION ALL
SELECT  'PLAYER_EVENT_CASTE_SYSTEM', 'TXT_KEY_PLAYER_EVENT_LABORCIVIC_CHOICE_4', 'TXT_KEY_PLAYER_EVENT_LABORCIVIC_CHOICE_4_HELP', 'LaborCivics.dds', -1, 1, 1, 1 UNION ALL
SELECT  'PLAYER_EVENT_INDUSTRIAL_SERVITUDE', 'TXT_KEY_PLAYER_EVENT_LABORCIVIC_CHOICE_5', 'TXT_KEY_PLAYER_EVENT_LABORCIVIC_CHOICE_5_HELP', 'LaborCivics.dds', -1, 1, 1, 1 UNION ALL
SELECT  'PLAYER_EVENT_EMANCIPATION', 'TXT_KEY_PLAYER_EVENT_LABORCIVIC_CHOICE_6', 'TXT_KEY_PLAYER_EVENT_LABORCIVIC_CHOICE_6_HELP', 'LaborCivics.dds', -1, 1, 1, 1 UNION ALL
SELECT  'PLAYER_EVENT_MECHANIZATION', 'TXT_KEY_PLAYER_EVENT_LABORCIVIC_CHOICE_7', 'TXT_KEY_PLAYER_EVENT_LABORCIVIC_CHOICE_7_HELP', 'LaborCivics.dds', -1, 1, 1, 1 UNION ALL
SELECT  'PLAYER_EVENT_MERCANTILISM', 'TXT_KEY_PLAYER_EVENT_ECONOMYCIVIC_CHOICE_2', 'TXT_KEY_PLAYER_EVENT_ECONOMYCIVIC_CHOICE_2_HELP', 'EconomyCivics.dds', -1, 1, 1, 1 UNION ALL
SELECT  'PLAYER_EVENT_FREE_MARKET', 'TXT_KEY_PLAYER_EVENT_ECONOMYCIVIC_CHOICE_3', 'TXT_KEY_PLAYER_EVENT_ECONOMYCIVIC_CHOICE_3_HELP', 'EconomyCivics.dds', -1, 1, 1, 1 UNION ALL
SELECT  'PLAYER_EVENT_STATE_PROPERTY', 'TXT_KEY_PLAYER_EVENT_ECONOMYCIVIC_CHOICE_4', 'TXT_KEY_PLAYER_EVENT_ECONOMYCIVIC_CHOICE_4_HELP', 'EconomyCivics.dds', -1, 1, 1, 1 UNION ALL
SELECT  'PLAYER_EVENT_CORPORATISM', 'TXT_KEY_PLAYER_EVENT_ECONOMYCIVIC_CHOICE_5', 'TXT_KEY_PLAYER_EVENT_ECONOMYCIVIC_CHOICE_5_HELP', 'EconomyCivics.dds', -1, 1, 1, 1 UNION ALL
SELECT  'PLAYER_EVENT_ENVIRONMENTALISM', 'TXT_KEY_PLAYER_EVENT_ECONOMYCIVIC_CHOICE_6', 'TXT_KEY_PLAYER_EVENT_ECONOMYCIVIC_CHOICE_6_HELP', 'EconomyCivics.dds', -1, 1, 1, 1 UNION ALL
SELECT  'PLAYER_EVENT_INGENIUSCRAFT', 'TXT_KEY_PLAYER_EVENT_ECONOMYCIVIC_CHOICE_7', 'TXT_KEY_PLAYER_EVENT_ECONOMYCIVIC_CHOICE_7_HELP', 'EconomyCivics.dds', -1, 1, 1, 1 UNION ALL
SELECT  'PLAYER_EVENT_ANCESTOR', 'TXT_KEY_PLAYER_EVENT_RELIGIONCIVIC_CHOICE_7', 'TXT_KEY_PLAYER_EVENT_RELIGIONCIVIC_CHOICE_7_HELP', 'ReligionCivics.dds', -1, 1, 1, 1 UNION ALL
SELECT  'PLAYER_EVENT_ORGANIZED_RELIGION', 'TXT_KEY_PLAYER_EVENT_RELIGIONCIVIC_CHOICE_2', 'TXT_KEY_PLAYER_EVENT_RELIGIONCIVIC_CHOICE_2_HELP', 'ReligionCivics.dds', -1, 1, 1, 1 UNION ALL
SELECT  'PLAYER_EVENT_THEOCRACY', 'TXT_KEY_PLAYER_EVENT_RELIGIONCIVIC_CHOICE_3', 'TXT_KEY_PLAYER_EVENT_RELIGIONCIVIC_CHOICE_3_HELP', 'ReligionCivics.dds', -1, 1, 1, 1 UNION ALL
SELECT  'PLAYER_EVENT_PACIFISM', 'TXT_KEY_PLAYER_EVENT_RELIGIONCIVIC_CHOICE_4', 'TXT_KEY_PLAYER_EVENT_RELIGIONCIVIC_CHOICE_4_HELP', 'ReligionCivics.dds', -1, 1, 1, 1 UNION ALL
SELECT  'PLAYER_EVENT_STATE_ATHEISM', 'TXT_KEY_PLAYER_EVENT_RELIGIONCIVIC_CHOICE_5', 'TXT_KEY_PLAYER_EVENT_RELIGIONCIVIC_CHOICE_5_HELP', 'ReligionCivics.dds', -1, 1, 1, 1 UNION ALL
SELECT  'PLAYER_EVENT_FREE_RELIGION', 'TXT_KEY_PLAYER_EVENT_RELIGIONCIVIC_CHOICE_6', 'TXT_KEY_PLAYER_EVENT_RELIGIONCIVIC_CHOICE_6_HELP', 'ReligionCivics.dds', -1, 1, 1, 1;

INSERT INTO Event_ParentEvents (EventChoiceType, EventType)
SELECT 'PLAYER_EVENT_HEREDITARY_RULE_CHOICE', 'PLAYER_EVENT_HEREDITARY_RULE' UNION ALL
SELECT 'PLAYER_EVENT_PATRONAGE_CHOICE', 'PLAYER_EVENT_PATRONAGE' UNION ALL
SELECT 'PLAYER_EVENT_REPRESENTATION_CHOICE', 'PLAYER_EVENT_REPRESENTATION' UNION ALL
SELECT 'PLAYER_EVENT_POLICE_STATE_CHOICE', 'PLAYER_EVENT_POLICE_STATE' UNION ALL
SELECT 'PLAYER_EVENT_UNIVERSAL_SUFFRAGE_CHOICE', 'PLAYER_EVENT_UNIVERSAL_SUFFRAGE' UNION ALL
SELECT 'PLAYER_EVENT_CONFEDERATION_CHOICE', 'PLAYER_EVENT_CONFEDERATION' UNION ALL
SELECT 'PLAYER_EVENT_CIVIL_LAW_CHOICE', 'PLAYER_EVENT_CIVIL_LAW' UNION ALL
SELECT 'PLAYER_EVENT_VASSALAGE_CHOICE', 'PLAYER_EVENT_VASSALAGE' UNION ALL
SELECT 'PLAYER_EVENT_BUREAUCRACY_CHOICE', 'PLAYER_EVENT_BUREAUCRACY' UNION ALL
SELECT 'PLAYER_EVENT_NATIONHOOD_CHOICE', 'PLAYER_EVENT_NATIONHOOD' UNION ALL
SELECT 'PLAYER_EVENT_FREE_SPEECH_CHOICE', 'PLAYER_EVENT_FREE_SPEECH' UNION ALL
SELECT 'PLAYER_EVENT_CONSTITUIONALISM_CHOICE', 'PLAYER_EVENT_CONSTITUIONALISM' UNION ALL
SELECT 'PLAYER_EVENT_SLAVERY_CHOICE', 'PLAYER_EVENT_SLAVERY' UNION ALL
SELECT 'PLAYER_EVENT_SERFDOM_CHOICE', 'PLAYER_EVENT_SERFDOM' UNION ALL
SELECT 'PLAYER_EVENT_CASTE_SYSTEM_CHOICE', 'PLAYER_EVENT_CASTE_SYSTEM' UNION ALL
SELECT 'PLAYER_EVENT_INDUSTRIAL_SERVITUDE_CHOICE', 'PLAYER_EVENT_INDUSTRIAL_SERVITUDE' UNION ALL
SELECT 'PLAYER_EVENT_MECHANIZATION_CHOICE', 'PLAYER_EVENT_MECHANIZATION' UNION ALL
SELECT 'PLAYER_EVENT_EMANCIPATION_CHOICE', 'PLAYER_EVENT_EMANCIPATION' UNION ALL
SELECT 'PLAYER_EVENT_MERCANTILISM_CHOICE', 'PLAYER_EVENT_MERCANTILISM' UNION ALL
SELECT 'PLAYER_EVENT_FREE_MARKET_CHOICE', 'PLAYER_EVENT_FREE_MARKET' UNION ALL
SELECT 'PLAYER_EVENT_STATE_PROPERTY_CHOICE', 'PLAYER_EVENT_STATE_PROPERTY' UNION ALL
SELECT 'PLAYER_EVENT_CORPORATISM_CHOICE', 'PLAYER_EVENT_CORPORATISM' UNION ALL
SELECT 'PLAYER_EVENT_ENVIRONMENTALISM_CHOICE', 'PLAYER_EVENT_ENVIRONMENTALISM' UNION ALL
SELECT 'PLAYER_EVENT_INGENIUSCRAFT_CHOICE', 'PLAYER_EVENT_INGENIUSCRAFT' UNION ALL
SELECT 'PLAYER_EVENT_ANCESTOR_CHOICE', 'PLAYER_EVENT_ANCESTOR' UNION ALL
SELECT 'PLAYER_EVENT_ORGANIZED_RELIGION_CHOICE', 'PLAYER_EVENT_ORGANIZED_RELIGION' UNION ALL
SELECT 'PLAYER_EVENT_THEOCRACY_CHOICE', 'PLAYER_EVENT_THEOCRACY' UNION ALL
SELECT 'PLAYER_EVENT_PACIFISM_CHOICE', 'PLAYER_EVENT_PACIFISM' UNION ALL
SELECT 'PLAYER_EVENT_STATE_ATHEISM_CHOICE', 'PLAYER_EVENT_STATE_ATHEISM' UNION ALL
SELECT 'PLAYER_EVENT_FREE_RELIGION_CHOICE', 'PLAYER_EVENT_FREE_RELIGION';

INSERT INTO EventChoices(Type, Description, Help)
SELECT 'PLAYER_EVENT_HEREDITARY_RULE_CHOICE', 'TXT_KEY_PLAYER_EVENT_GOVERNMENTCIVIC_CHOICE_2', 'TXT_KEY_PLAYER_EVENT_GOVERNMENTCIVIC_CHOICE_2_HELP' UNION ALL
SELECT 'PLAYER_EVENT_PATRONAGE_CHOICE', 'TXT_KEY_PLAYER_EVENT_GOVERNMENTCIVIC_CHOICE_3', 'TXT_KEY_PLAYER_EVENT_GOVERNMENTCIVIC_CHOICE_3_HELP' UNION ALL
SELECT 'PLAYER_EVENT_REPRESENTATION_CHOICE', 'TXT_KEY_PLAYER_EVENT_GOVERNMENTCIVIC_CHOICE_4', 'TXT_KEY_PLAYER_EVENT_GOVERNMENTCIVIC_CHOICE_4_HELP' UNION ALL
SELECT 'PLAYER_EVENT_POLICE_STATE_CHOICE', 'TXT_KEY_PLAYER_EVENT_GOVERNMENTCIVIC_CHOICE_5', 'TXT_KEY_PLAYER_EVENT_GOVERNMENTCIVIC_CHOICE_5_HELP' UNION ALL
SELECT 'PLAYER_EVENT_UNIVERSAL_SUFFRAGE_CHOICE', 'TXT_KEY_PLAYER_EVENT_GOVERNMENTCIVIC_CHOICE_6', 'TXT_KEY_PLAYER_EVENT_GOVERNMENTCIVIC_CHOICE_6_HELP' UNION ALL
SELECT 'PLAYER_EVENT_CONFEDERATION_CHOICE', 'TXT_KEY_PLAYER_EVENT_GOVERNMENTCIVIC_CHOICE_7', 'TXT_KEY_PLAYER_EVENT_GOVERNMENTCIVIC_CHOICE_7_HELP' UNION ALL
SELECT 'PLAYER_EVENT_CIVIL_LAW_CHOICE', 'TXT_KEY_PLAYER_EVENT_LEGALCIVIC_CHOICE_2', 'TXT_KEY_PLAYER_EVENT_LEGALCIVIC_CHOICE_2_HELP' UNION ALL
SELECT 'PLAYER_EVENT_VASSALAGE_CHOICE', 'TXT_KEY_PLAYER_EVENT_LEGALCIVIC_CHOICE_3', 'TXT_KEY_PLAYER_EVENT_LEGALCIVIC_CHOICE_3_HELP' UNION ALL
SELECT 'PLAYER_EVENT_BUREAUCRACY_CHOICE', 'TXT_KEY_PLAYER_EVENT_LEGALCIVIC_CHOICE_4', 'TXT_KEY_PLAYER_EVENT_LEGALCIVIC_CHOICE_4_HELP' UNION ALL
SELECT 'PLAYER_EVENT_NATIONHOOD_CHOICE', 'TXT_KEY_PLAYER_EVENT_LEGALCIVIC_CHOICE_5', 'TXT_KEY_PLAYER_EVENT_LEGALCIVIC_CHOICE_5_HELP' UNION ALL
SELECT 'PLAYER_EVENT_FREE_SPEECH_CHOICE', 'TXT_KEY_PLAYER_EVENT_LEGALCIVIC_CHOICE_6', 'TXT_KEY_PLAYER_EVENT_LEGALCIVIC_CHOICE_6_HELP' UNION ALL
SELECT 'PLAYER_EVENT_CONSTITUIONALISM_CHOICE', 'TXT_KEY_PLAYER_EVENT_LEGALCIVIC_CHOICE_7', 'TXT_KEY_PLAYER_EVENT_LEGALCIVIC_CHOICE_7_HELP' UNION ALL
SELECT 'PLAYER_EVENT_SLAVERY_CHOICE', 'TXT_KEY_PLAYER_EVENT_LABORCIVIC_CHOICE_2', 'TXT_KEY_PLAYER_EVENT_LABORCIVIC_CHOICE_2_HELP' UNION ALL
SELECT 'PLAYER_EVENT_SERFDOM_CHOICE', 'TXT_KEY_PLAYER_EVENT_LABORCIVIC_CHOICE_3', 'TXT_KEY_PLAYER_EVENT_LABORCIVIC_CHOICE_3_HELP' UNION ALL
SELECT 'PLAYER_EVENT_CASTE_SYSTEM_CHOICE', 'TXT_KEY_PLAYER_EVENT_LABORCIVIC_CHOICE_4', 'TXT_KEY_PLAYER_EVENT_LABORCIVIC_CHOICE_4_HELP' UNION ALL
SELECT 'PLAYER_EVENT_INDUSTRIAL_SERVITUDE_CHOICE', 'TXT_KEY_PLAYER_EVENT_LABORCIVIC_CHOICE_5', 'TXT_KEY_PLAYER_EVENT_LABORCIVIC_CHOICE_5_HELP' UNION ALL
SELECT 'PLAYER_EVENT_EMANCIPATION_CHOICE', 'TXT_KEY_PLAYER_EVENT_LABORCIVIC_CHOICE_6', 'TXT_KEY_PLAYER_EVENT_LABORCIVIC_CHOICE_6_HELP' UNION ALL
SELECT 'PLAYER_EVENT_MECHANIZATION_CHOICE', 'TXT_KEY_PLAYER_EVENT_LABORCIVIC_CHOICE_7', 'TXT_KEY_PLAYER_EVENT_LABORCIVIC_CHOICE_7_HELP' UNION ALL
SELECT 'PLAYER_EVENT_INGENIUSCRAFT_CHOICE', 'TXT_KEY_PLAYER_EVENT_ECONOMYCIVIC_CHOICE_7', 'TXT_KEY_PLAYER_EVENT_ECONOMYCIVIC_CHOICE_7_HELP' UNION ALL
SELECT 'PLAYER_EVENT_MERCANTILISM_CHOICE', 'TXT_KEY_PLAYER_EVENT_ECONOMYCIVIC_CHOICE_2', 'TXT_KEY_PLAYER_EVENT_ECONOMYCIVIC_CHOICE_2_HELP' UNION ALL
SELECT 'PLAYER_EVENT_FREE_MARKET_CHOICE', 'TXT_KEY_PLAYER_EVENT_ECONOMYCIVIC_CHOICE_3', 'TXT_KEY_PLAYER_EVENT_ECONOMYCIVIC_CHOICE_3_HELP' UNION ALL
SELECT 'PLAYER_EVENT_STATE_PROPERTY_CHOICE', 'TXT_KEY_PLAYER_EVENT_ECONOMYCIVIC_CHOICE_4', 'TXT_KEY_PLAYER_EVENT_ECONOMYCIVIC_CHOICE_4_HELP' UNION ALL
SELECT 'PLAYER_EVENT_CORPORATISM_CHOICE', 'TXT_KEY_PLAYER_EVENT_ECONOMYCIVIC_CHOICE_5', 'TXT_KEY_PLAYER_EVENT_ECONOMYCIVIC_CHOICE_5_HELP' UNION ALL
SELECT 'PLAYER_EVENT_ENVIRONMENTALISM_CHOICE', 'TXT_KEY_PLAYER_EVENT_ECONOMYCIVIC_CHOICE_6', 'TXT_KEY_PLAYER_EVENT_ECONOMYCIVIC_CHOICE_6_HELP' UNION ALL
SELECT 'PLAYER_EVENT_ANCESTOR_CHOICE', 'TXT_KEY_PLAYER_EVENT_RELIGIONCIVIC_CHOICE_7', 'TXT_KEY_PLAYER_EVENT_RELIGIONCIVIC_CHOICE_7_HELP' UNION ALL
SELECT 'PLAYER_EVENT_ORGANIZED_RELIGION_CHOICE', 'TXT_KEY_PLAYER_EVENT_RELIGIONCIVIC_CHOICE_2', 'TXT_KEY_PLAYER_EVENT_RELIGIONCIVIC_CHOICE_2_HELP' UNION ALL
SELECT 'PLAYER_EVENT_THEOCRACY_CHOICE', 'TXT_KEY_PLAYER_EVENT_RELIGIONCIVIC_CHOICE_3', 'TXT_KEY_PLAYER_EVENT_RELIGIONCIVIC_CHOICE_3_HELP' UNION ALL
SELECT 'PLAYER_EVENT_PACIFISM_CHOICE', 'TXT_KEY_PLAYER_EVENT_RELIGIONCIVIC_CHOICE_4', 'TXT_KEY_PLAYER_EVENT_RELIGIONCIVIC_CHOICE_4_HELP' UNION ALL
SELECT 'PLAYER_EVENT_STATE_ATHEISM_CHOICE', 'TXT_KEY_PLAYER_EVENT_RELIGIONCIVIC_CHOICE_5', 'TXT_KEY_PLAYER_EVENT_RELIGIONCIVIC_CHOICE_5_HELP' UNION ALL
SELECT 'PLAYER_EVENT_FREE_RELIGION_CHOICE', 'TXT_KEY_PLAYER_EVENT_RELIGIONCIVIC_CHOICE_6', 'TXT_KEY_PLAYER_EVENT_RELIGIONCIVIC_CHOICE_6_HELP';