...
VALUES
	('UNIT_MISSILE_DESTROYER', 'UNITCLASS_MISSILE_DESTROYER', 'DOMAIN_SEA', 'UNITCOMBAT_NAVALMELEE', 'TECH_STEALTH', 'TECH_PARTICLE_PHYSICS', 'UNITAI_ATTACK_SEA',
	...
	2600, 1400, 1, 90, 6, 0, 0, 3, 2,
	1, 1, 1, 1, 1,
	60, 10, 3, 3, 'BOAT',
	35, 'SPECIALUNIT_MISSILE', 'DOMAIN_AIR', 1,
...
INSERT INTO Unit_ClassUpgrades (UnitType, UnitClassType)
VALUES ('UNIT_MISSILE_DESTROYER', 'UNITCLASS_ADVANCED_DESTROYER');
...
VALUES
	('UNIT_MISSILE_DESTROYER', 'PROMOTION_ANTI_SUBMARINE_II'),
	('UNIT_MISSILE_DESTROYER', 'PROMOTION_INTERCEPTION_I'),
	('UNIT_MISSILE_DESTROYER', 'PROMOTION_INTERCEPTION_II'),    
	('UNIT_MISSILE_DESTROYER', 'PROMOTION_CARGO_III');
...
VALUES ('TECH_LASERS', 'FLAVOR_NAVAL', 11);
...
VALUES
	('UNIT_MISSILE_DESTROYER', 'FLAVOR_NAVAL', 60),
	('UNIT_MISSILE_DESTROYER', 'FLAVOR_NAVAL_RECON', 30);
...
INSERT INTO Language_en_US (Tag, Text)
VALUES ('TXT_KEY_UNIT_MISSILE_DESTROYER_STRATEGY', 'Missile Destroyer is a contemporary version of a Destroyer that can carry 3 Missiles and has increased air interception range. It should be used as an attack or an escort unit.');

-- Pedia: Game Info (top)
INSERT INTO Language_en_US (Tag, Text)
VALUES ('TXT_KEY_UNIT_MISSILE_DESTROYER_HELP', 'Missile Destroyer can carry 3 Missiles, has increased air interception range and chance, and additional attack strength against submarines.');
