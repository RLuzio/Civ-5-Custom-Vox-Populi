...
UPDATE Units SET CoastalFireOnly = '1' WHERE Type = 'UNIT_SUPERCARRIER';
...
VALUES
	...
	('UNIT_SUPERCARRIER', 'PROMOTION_INTERCEPTION_I'),
	('UNIT_SUPERCARRIER', 'PROMOTION_INTERCEPTION_II'),
	('UNIT_SUPERCARRIER', 'PROMOTION_INTERCEPTION_III'),
	('UNIT_SUPERCARRIER', 'PROMOTION_ANTI_AIR'),    
...
-- Pedia: Game Info (top)
INSERT INTO Language_en_US (Tag, Text)
VALUES ('TXT_KEY_UNIT_SUPERCARRIER_HELP', 'Carries 5 aircrafts (up to 8), has air interception range increased to 5 and can detect submarines. Limited to 2 units per player. Requires [ICON_RES_URANIUM] Uranium to be built.');
