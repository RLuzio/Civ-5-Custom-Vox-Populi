...
UPDATE UnitPromotions SET IconAtlas = 'tempVPPI_Atlas' WHERE Type = 'PROMOTION_IKLWA'; -- Yellow Triangle like a inclined star
UPDATE UnitPromotions SET PortraitIndex = '7' WHERE Type = 'PROMOTION_IKLWA';
